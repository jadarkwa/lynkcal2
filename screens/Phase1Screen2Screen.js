        ...
        >
          ...
          <View style={StyleSheet.applyWidth({ marginBottom: 50 }, dimensions.width)}>
            ...
            <View style={{ marginHorizontal: 10 }}>
              ...
              <Touchable onPress={showCalendar}>
                <View style={{ 
                  alignItems: 'center', 
                  marginTop: 15,
                  ...
                  <Text style={{
                    ...
                    {`${selectedDates.length}/7 days selected (tap to change)`}
                  </Text>
                </View>
              </Touchable>
                ...
                <View style={{
                  ...
                  <View style={{
                    ...
                    <Calendar
                      ...
                      theme={{
                        todayTextColor: 'rgb(211, 39, 148)',
                        selectedDayBackgroundColor: 'rgb(211, 39, 148)',
                        selectedDayTextColor: '#ffffff',
                        dotColor: 'rgb(211, 39, 148)',
                        arrowColor: 'rgb(211, 39, 148)',
                      }}
                    />
